...
// 1. select the team-container class
// 2. select the search class

const teamContainer = document.querySelector(".team-container");
const search = document.querySelector(".search");

// 4. assin the team to data to a variable
...
// 6. wrap this for loop in the function and then we use it
